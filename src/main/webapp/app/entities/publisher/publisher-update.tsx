  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="libraryApp.publisher.home.createOrEditLabel" data-cy="PublisherCreateUpdateHeading">
            <Translate contentKey="libraryApp.publisher.home.createOrEditLabel">Create or edit a Publisher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('libraryApp.publisher.name')}
                id="publisher-name"
                name="name"
                data-cy="name"
                type="text"
