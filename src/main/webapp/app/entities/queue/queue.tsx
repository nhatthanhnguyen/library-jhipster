  ...
  return (
    <div>
      <h2 id="queue-heading" data-cy="QueueHeading">
        <Translate contentKey="libraryApp.queue.home.title">Queues</Translate>
        ...
        {queueList && queueList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="libraryApp.queue.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="libraryApp.queue.book">Book</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="libraryApp.queue.home.notFound">No Queues found</Translate>
            </div>
          )
        )}
      </div>
